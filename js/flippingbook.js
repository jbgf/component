...
//swf资源
	swfobject.embedSWF("/source/FlippingBook.swf", this.containerId, this.stageWidth, this.stageHeight, "8.0.0", "/source/expressInstall.swf", this.settings, {allowScriptAccess: "always", bgcolor:  "#" + this.settings.backgroundColor.toString( 16 ),height:"1080px;" });
}
